...
public class Inputter {
    ...
    public static String getStringO(String welcome, String oldData) {
    ...
    public static int getIntO(String welcome, int min, int max, int oldData) {
        boolean check = true;
        int number = oldData;
        do {
            try {
    ...
    public static double getDoubleO(String welcome, double min, double max, double oldData) {
        boolean check = true;
